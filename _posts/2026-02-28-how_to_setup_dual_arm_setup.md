...
## How to configure Multiple robots for dual arm control in MoveIt2

There is not just a single way to solve the dual arm problem in MoveIt2. here we'll discuss three distinct architectural approaches, each with different tradeoffs for collision awareness, scalability, and implementation complexity.
...
|----------|-------|--------|
| Base-to-base separation | **800 mm** | Physically measured; validated hardware setup |
| Spec reach per arm | 490 mm | Ned2 User Manual v1.0.0 §2.2 |
